...
public class TabNavigationLocators extends BaseConfig {
	
	public TabNavigationLocators(WebDriver driver) {
		super(driver);
	}
	public TabNavigationLocators(WebDriver driver, String url) {
		super(driver, url);
	}
